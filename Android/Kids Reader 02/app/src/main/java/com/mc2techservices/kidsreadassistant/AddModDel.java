...
import com.mc2techservices.kidsreadassistant.supportcode.DBAdapter;
...
public class AddModDel extends Activity {
    ...
    public void GoWhereNow()
    {
        if (!EntryPoint.equals("DLArea")) finish();
        final Dialog nsp = new Dialog(this);
        nsp.requestWindowFeature(Window.FEATURE_NO_TITLE);
        nsp.setContentView(R.layout.custom_dialog_dl_more_or_your_data);
        //nsp.setTitle("Welcome to Pocket Cube Solver!");
        Button cmdContinue = nsp.findViewById(R.id.buttonDoDL);
        Button cmdCancel = nsp.findViewById(R.id.buttonDontDL);
